...
class wp_nav_menu extends Shared\Base {
	...
	/**
	 * The aria-label attribute that is applied to the container when it's a nav element. Default empty.
	 */
	...
	/**
	 * How many levels of the hierarchy are to be included. 0 means all. Default 0.
	 */
	public int $depth;
