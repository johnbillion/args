...
class register_post_status extends Shared\Base {
	...
	/**
	 * Whether the status is for internal use only. Default false.
	 */
	public bool $internal;

	/**
	 * Whether posts with this status should be protected. Default false.
	 */
	public bool $protected;

	/**
	 * Whether posts with this status should be private. Default false.
	 */
	public bool $private;
	...
	/**
	 * Whether the post has a floating creation date. Default to false.
	 */
